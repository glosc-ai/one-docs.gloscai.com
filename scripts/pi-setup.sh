...
main() {
  local config_file="$HOME/.pi/agent/models.json" existing_token auth_token default_model
  existing_token="$(read_env_from_rcs 'ONE_API_KEY')"
  echo '=== Pi setup ==='; echo; echo "baseUrl will be set to: $DEFAULT_BASE_URL"; echo
