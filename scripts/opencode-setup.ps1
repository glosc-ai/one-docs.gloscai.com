...
$configFile = Join-Path (Join-Path (Join-Path $HOME '.config') 'opencode') 'opencode.json'
...
Write-Host 'Open a new terminal window before running opencode.'